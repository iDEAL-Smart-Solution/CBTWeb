...
//     const { loading, schoolDetails, fetchSchoolDetails, updateSubscription } = useSchoolStore();
//     const { id } = useParams();
...
//             if (schoolDetails.schoolSubscription) {
//                 schoolDetails.schoolSubscription.allowedStudentCount = Number(formData.allowedStudentCount);
//                 schoolDetails.schoolSubscription.amountPaid = Number(formData.amountPaid);
//                 schoolDetails.schoolSubscription.createdAt = new Date(formData.createdAt).toISOString();
//             }
//             closeModal();
//             fetchSchoolDetails(id);
//         } catch (error) {
...
//                                     className="text-sm w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
//                                     placeholder="Enter allowed student count"
//                                     min="1"
//                                 />
//                                 {errors.allowedStudentCount && (
//                                     <p className="text-xs text-red-600 mt-1">{errors.allowedStudentCount}</p>
//                                 )}
//                             </div>
//                             <div>
//                                 <label className="block text-sm font-medium text-gray-700 mb-1">
...
//                                 />
//                                 {errors.createdAt && (
//                                     <p className="text-xs text-red-600 mt-1">{errors.createdAt}</p>
//                                 )}
//                             </div>
//                             {errors.general && (
...
//                                     type="button"
//                                     onClick={closeModal}
//                                     className="w-full sm:w-auto px-4 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-300 transition-colors"
//                                 >
//                                     Cancel
//                                 </button>
//                                 <button
...
//         } else {
//             const selectedDate = new Date(formData.createdAt);
//             const today = new Date("2025-06-02"); // Current date
//             if (selectedDate > today) {
//                 newErrors.createdAt = "Created date cannot be in the future";
//             }
//         }
