...
export default function ExamCreation() {
     ...
     return (
          <div>
               ...
               <ExamCreationForm handleInputChange={handleInputChange} handleReset={handleReset} handleSubmit={handleSubmit} formData={formData} subjects={subjects} loading={loading} />
          </div>
     )
}