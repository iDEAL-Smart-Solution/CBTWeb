  ...
  return (
    <div>
      {theory.length > 0 && !showTheory && (
        <button onClick={() => setShowTheory(true)} style={{
          all: 'unset',
          width: '10%',
          textAlign: 'center',
          padding: '10px',
            ...
            <div className='left-fraction'>
              ...
              {theory.map((item, index) => (
                <div key={index} className="text-big-3">
                  {item.questionInstruction && item.questionInstruction !== '--' && <p>{item.questionInstruction}</p>}
        ...
        <div className='exam-question-box'>
          <div className='left-fraction'>
            ...
            {currentQuestion.questionInstruction?.trim() && currentQuestion.questionInstruction !== "--" && (
              <small className='bolder'>{currentQuestion.questionInstruction}</small>
            )}
